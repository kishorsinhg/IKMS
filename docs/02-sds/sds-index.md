...
This index tracks design slices for SDS-based development.

Each SDS slice should be small enough to implement and test independently.
...
| SDS-011 | Audit & Reporting | Planned | `08-security/audit-baseline.md` |
| SDS-012 | Operations & Deployment | Planned | `10-operations/deployment-model.md` |
